...
#
# author :  flagellantX , version 1.0
# ----------------------------------------------------------------------------------------------
...
def usage():
	print " If it is HTTPS, it will also be written as HTTP. "
	print " theurgy.py http://www.target.com/ "
	print " theurgy.py 127.0.0.1 "
